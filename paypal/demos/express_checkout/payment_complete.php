...
<head>
    <meta charset="utf-8">
    <title>Congratulations! Payment Complete</title>
                ...
                <div class="col-md-6 column">
                    <div id="angelleye-logo">
                        <a href="<?php echo site_url('main');?>">
                            <img class="img-responsive" src="<?= base_url('static/img/EC_logo-Black.png') ?>">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4 column">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>$<?= $cart['shopping_cart']['grand_total'] ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            </div>
            <a class="btn btn-primary" href="<?php echo site_url('main');?>">Go to Main</a>
        </div>
    </div>
</div>
</body>
