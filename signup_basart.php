...
<div class="container">
  ...
  <form id="signup" action="<?= base_url('regproc/basart')?>" method="post" class="form-signin" autocomplete="off">
    <h1 class="h3 mb-3 font-weight-normal"><b>Register</b></h1>
    <h2 class="h4 mb-4 font-weight-normal"><b>Basic Artist/Designer</b></h2>
    ...
    <center>
      <input name="email" type="email" id="inputEmail" style= width:500px class="form-control" placeholder="Email address *" required autofocus ><br>
    </center>
    ...
    <center>
        <div id="alert-danger-pass" class="alert alert-danger alert-dismissible fade-in" style="width: 500px; display: none; margin-top: -20px;">
            ...
            <span>**Please Confirm Same Password.**</span>
        </div>        
    </center>
    
    <label for="inputPostalCode" class="sr-only">Zip Code</label>
    <center>
      <input name="postalcode" type="number" id="inputPostalcode" style= width:500px class="form-control" placeholder="Zip Code *" required><br>
    </center>
