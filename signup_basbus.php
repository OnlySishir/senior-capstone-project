...
<div class="container">
  ...
  <?php } ?>
  <form id="signup" action="<?= base_url('regproc/basbus')?>" method="post" class="form-signin" autocomplete="off" enctype="multipart/form-data">
    <h1 class="h3 mb-3 font-weight-normal"><b>Register</b></h1>
    <h2 class="h4 mb-4 font-weight-normal"><b>Basic Business/Trade</b></h2>
    ...
    <center>
        <div id="alert-danger" class="alert alert-danger alert-dismissible fade-in" style="width: 500px; display: none;">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <strong>Warning!</strong><span id="ErrorContent"> **Please accept our Terms and Conditions.**
        </span></div>        
    </center>
