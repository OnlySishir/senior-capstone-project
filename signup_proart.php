...
<div class="container">
  ...
  <?php } ?>
  <form id="signup" action="<?= base_url('regproc/proart')?>" method="post" class="form-signin" autocomplete="off">
    <h1 class="h3 mb-3 font-weight-normal"><b>Register</b></h1>
    <h2 class="h4 mb-4 font-weight-normal"><b>Professional Artist/Designer</b></h2>
